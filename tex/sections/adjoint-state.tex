...
\begin{equation}
    ...
    \label{eq:dhdtheta}
\end{equation}
Importantly, the right-hand side of Equation \eqref{eq:dhdtheta} can be resolved as a vector-Jacobian product (VJP), with $\frac{\partial L}{\partial U}$ being the vector.
