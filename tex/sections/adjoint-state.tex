...
\begin{equation}
    ...
    - 
    \underbrace{\frac{\partial h}{\partial U}}_{\text{vector}}
...
\begin{equation}
    \frac{dh}{d\theta} 
    = 
    \frac{\partial h}{\partial \theta} - \lambda^T \left( \frac{\partial A }{\partial \theta} U - \frac{\partial b}{\partial \theta} \right)
...
\begin{equation}
    \lambda_{i} = A_{i}^T \lambda_{i+1} + \left( \frac{\partial h}{\partial u}^T \right)_i
\end{equation}
