...
Intuitively, we can think about $\epsilon$ as being a differential in the Taylor expansion, fact that we can observe in how the output of any scalar functions is extended to a dual number output:
\begin{align}
    f(x_1 + \epsilon x_2)
    &= 
    f(x_1)
...
This derivative is often referred to as the adjoint or cotangent, and its connection with the discrete adjoint method will be made more explicitly in Section \ref{section:is-discrete-adjoint-AD}. 
