...
Examples of these data structures include dual numbers and computational graphs \cite{Baydin_Pearlmutter_Radul_Siskind_2015}. Note that these representations are mathematically equivalent and lead to the same implementation sans details in the compiler optimizations with respect to floating point ordering.
