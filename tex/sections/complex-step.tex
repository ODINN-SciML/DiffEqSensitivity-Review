...
However, a major limitation of this method is that it only just for locally complex analytical functions \cite{Martins_Sturdza_Alonso_2003_complex_differentiation} and does not outperform AD. 
