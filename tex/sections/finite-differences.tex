...
However, there are a series of problems associated with finite differences.
The first one is due to how it scales with the dimension $p$ of parameter vector $\theta$.
