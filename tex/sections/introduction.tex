...
Dynamical systems governed by differential equations are not an exception to the rule. \todo{which rule? Here we could say that the solution of differential equations can be seen as functions which map parameter and initial conditions to state variables, similarly to machine learning models.}
...
\end{quote}
\todo[inline]{No connection between Julia and the above question.}
...
\todo[inline]{It would be nice to have a paragraph which announces the structure of the paper. Overall, I also feel like the structure in the form of questions could be whether improved, or paragraph could simply be concatenated without questions.}
% \begin{quote}
%     \textbf{Question 3. }
