...
The constrained optimization problem is transformed into an unconstrained problem by way of a Lagrange multiplier method, also referred to as the adjoint method \cite{Vadlamani.2020}. 
