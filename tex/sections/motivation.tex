...
\todo[inline]{here I would actually mention sensitivity analysis as a way to bridge the two worlds. Then I would introduce differentiable programming as a game changer to performe sensitivity analysis.}
