...
\begin{equation}
    ...
    \frac{dL}{d\theta^k}.
\end{equation}
There exist different variants of gradient descent methods\cite{ruder2016overview-gradient-descent}, and in general they outperform gradient-free optimization schemes.
