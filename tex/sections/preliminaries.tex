...
\begin{itemize}
    ...
    \todo{\tiny See my earlier comment: in general, y = H u, with H the state-to-obs operator}
...
% Thinking about adding some simple intro to numerical solvers, which in any way we will need in order to treat adjoint methods. 
