...
\begin{enumerate}
    ...
    Certain AD Packages like \texttt{ReverseDiff.jl} do not support GPU (Graphical Processing Units) operations, while others like \texttt{JAX}, \texttt{Enzyme.jl} and \texttt{Zygote.jl} support it. 
